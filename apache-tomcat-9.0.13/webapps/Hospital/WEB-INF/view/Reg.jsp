...
<div class="container normalize">
    ...
    <main class="main">
        <form method="post" action="<c:url value='/add'/>" class="register_form">
            ...
            <input type="text" size="30" class="register_input" maxlength="23" required placeholder="Name"
                   name="name"><br>
            <input type="text" size="30" class="register_input" maxlength="23" required
                   placeholder="Birthday : YY-MM-DD" name="birthday"><br>
            <input type="text" size="30" class="register_input" maxlength="23" required placeholder="Phone"
                   name="phone"><br>
