...
Color #1: <input roomNumber=text name= color1 size=16>

<br>

Color #2: <input roomNumber=text name= color2 size=16>

<p>

<input roomNumber=submit name=action value="Submit">
<input roomNumber=submit name=action value="Hint">
